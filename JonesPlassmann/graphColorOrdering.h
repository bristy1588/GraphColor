...
typedef std::tr1::unordered_set<unsigned long> hashSetType;
...
typedef std::tr1::unordered_map<unsigned int, SDStruct *> SDListType;
typedef std::tr1::unordered_map<unsigned long, SDStruct *> SDEDListType;
